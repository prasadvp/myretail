	...
	public void delete() {
	 ...
	 public ProductPriceEntity update(ProductPriceEntity entity) {
		 Query query = new Query(Criteria.where("productId").is(entity.getProductId()));
	        ...
	        if(result==null) {
	        		throw new RetailServiceException(RetailConstants.PRODUCT_OBJ_NOT_FOUND_EXCEPTION.getCode(), RetailConstants.PRODUCT_OBJ_NOT_FOUND_EXCEPTION.getDescription());
	        }
			return entity;
		}
}
